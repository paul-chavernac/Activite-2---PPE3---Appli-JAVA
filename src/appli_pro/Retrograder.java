 ...
 * @author rafac
 */
public class Retrograder extends javax.swing.JDialog {

    private InterfaceGraphique fenetre;

    /**
     * Creates new form Retrograder
     */
    public Retrograder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Retrograder un Responsable");

        jLabel2.setText("Nom :");

        jLabel3.setText("Prenom :");

        jLabel4.setText("Retrogradation :");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Employée", " " }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPrenom, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEnregistrerActionPerformed
        ...
        if (jNom.getText().length() == 0 || jPrenom.getText().length() == 0) {
            ...
            try {
                ...
                int leroele = jComboBox1.getSelectedIndex() + 2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Retrograder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Retrograder dialog = new Retrograder(new javax.swing.JFrame(), true);
